emcc  -I../include -o neuropia_t.js \
      --bind  --no-heap-copy -s ASSERTIONS=1 -s SAFE_HEAP=0 -s WASM=1 -O3 -s INVOKE_RUN=0 -s ERROR_ON_UNDEFINED_SYMBOLS=1 -s FORCE_FILESYSTEM=1 -s ALLOW_MEMORY_GROWTH=0 -s TOTAL_MEMORY=512MB --preload-file mnist -s EXIT_RUNTIME=1 -std=c++14 --source-map-base http://localhost:8000/ -g4  \
    ../src/idxreader.cpp \
    ../src/neuropia.cpp \
    ../src/utils.cpp \
    ../src/testports.cpp \
